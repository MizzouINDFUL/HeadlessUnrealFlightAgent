...
if (len(sys.argv) < 2):
    print("usage: python3 _unreal_ros_groundt_truth_color_no_target.py num_messages")
    exit(1)
else:
...
class ImageExtractor():
    def __init__(self, folder_name=None) -> None:
        ...
        self.rgb_path = os.path.join(self.session_path, "gt_color_no_target")
        ...
        self.image_sub = rospy.Subscriber("/unreal_ros/ground_truth_color_no_target", Image, self.image_callback)
        rospy.spin()
